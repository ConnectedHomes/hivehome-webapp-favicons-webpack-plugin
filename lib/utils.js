...
var resizeImage = exports.resizeImage = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(source, target, width, height) {
        var sourceImg;
                ...
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        ...
                        return _context.abrupt('return', new _promise2.default(function (resolve, reject) {
                            try {
                                sourceImg.resize(width, height).write(target, function () {
    ...
    return function resizeImage(_x, _x2, _x3, _x4) {
...
var convertToIco = exports.convertToIco = function () {
    ...
    return function convertToIco(_x5, _x6) {
...
var injectHashIntoFilename = exports.injectHashIntoFilename = function () {
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return (0, _promise4.default)(file);
    ...
    return function injectHashIntoFilename(_x7, _x8) {
